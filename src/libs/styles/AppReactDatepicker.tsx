...
const StyledReactDatePicker = styled(Box)<BoxProps>(({ theme }) => {
  return {
    ...
    '& .react-datepicker': {
      color: 'var(--mui-palette-text-error)',
      ...
      '& .react-datepicker__month-text--today': {
        ...
        '&:not(.react-datepicker__month-text--selected)': {
          ...
          '&:hover': {
            backgroundColor: 'rgb(var(--mui-palette-error-mainChannel) / 0.04)'
          }
        }
      },
      '& .react-datepicker__year-text--today': {
        ...
        '&:not(.react-datepicker__year-text--selected)': {
          ...
          '&.react-datepicker__year-text--keyboard-selected': {
            color: 'var(--mui-palette-error-main)',
            backgroundColor: 'rgb(var(--mui-palette-error-mainChannel) / 0.06)',
            '&:hover': {
              color: 'var(--mui-palette-error-main)',
              backgroundColor: 'rgb(var(--mui-palette-error-mainChannel) / 0.06)'
            }
      ...
      '& .react-datepicker__day--keyboard-selected': {
        '&:not(.react-datepicker__day--in-range)': {
          color: 'var(--mui-palette-error-main)',
          backgroundColor: 'rgb(var(--mui-palette-error-mainChannel) / 0.16)',
          '&:hover': {
            backgroundColor: 'rgb(var(--mui-palette-error-mainChannel) / 0.16)'
          }
        }
      ...
      '& .react-datepicker__day--selected, & .react-datepicker__month-text--selected, & .react-datepicker__year-text--selected, & .react-datepicker__quarter-text--selected':
      {
        ...
        boxShadow: 'var(--mui-customShadows-error-sm)',
        '&:hover': {
          backgroundColor: 'var(--mui-palette-error-dark) !important'
        }
      },
      '& .react-datepicker__header__dropdown': {
        ...
        {
          borderColor: 'var(--mui-palette-text-error)'
        },
        ...
        '& .react-datepicker__year-option': {
          ...
          '&:hover .react-datepicker__navigation--years-upcoming': {
            borderTopColor: 'var(--mui-palette-text-error)',
            borderRightColor: 'var(--mui-palette-text-error)'
          },
          ...
          '&:hover .react-datepicker__navigation--years-previous': {
            borderLeftColor: 'var(--mui-palette-text-error)',
            borderBottomColor: 'var(--mui-palette-text-error)'
          }
        }
      },
