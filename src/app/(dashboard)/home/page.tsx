            ...
            <TabContext value={value}>
              ...
              <CardContent>
                <TabPanel value='1'>
                  ...
                  <Button variant='contained' color='info'>Button One</Button>
                </TabPanel>
                <TabPanel value='2'>
                  <Typography variant='h5' className='mbe-2'>
                    Header Two
                  ...
                  <Button variant='contained' color='warning'>Button Two</Button>
                </TabPanel>
                <TabPanel value='3'>
                  <Typography variant='h5' className='mbe-2'>
                    Header Three
                  ...
                  <Button variant='contained' className='mbe-2' color='success'>Button Three</Button>
                </TabPanel>
              </CardContent>
            </TabContext>
          </Card>
